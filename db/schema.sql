...
CREATE TABLE departments( -- a table created for 'departments'
    id INT AUTO_INCREMENT PRIMARY KEY NOT NULL, -- a unique id will be given to the department table, which is auto generated
    name VARCHAR(50) -- the name of the department, 50 characters max
);

CREATE TABLE roles( -- a table created for 'roles'
    id INT AUTO_INCREMENT PRIMARY KEY NOT NULL,  -- a unique id will be given to the roles table, which is auto generated
    ...
    department_id INT, -- department_id shows the relationship between the roles and departments. It will be given a number as an id
...
CREATE TABLE employees( -- a table created for 'employees'
    ...
    role_id INT NOT NULL, -- role_id shows the relationship between the employees and roles table. It will be given a number as an id
    manager_id INT, -- manager_id shows the relationship between the employees and roles table. It will be given a number as an id. Did not add null as some employees may not have a manager so will be left blank
